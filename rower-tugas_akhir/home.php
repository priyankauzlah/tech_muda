  ...
  <div class="jumbotron">
    <div class="row">
      ...
      <div class="col-md-6" style="margin-left:70px;">
        <h2><b>Selamat datang di toko sepeda murah.<h1>Dodol<b>sepeda.pol</b></h1>
        </h2>
      ...
      ?>
          ...
          <div class="col-md-4" style="margin-top:20px;">
            <div class="buku">
              ...
              <h3 style="text-align:center; color:#007DBC;"><?php echo $buku['judul'] ?></h3>
        ...
        while ($buku1 = mysql_fetch_array($qrybukukat)) { ?>
          <div class="col-md-4" style="margin-top:20px;">
            <div class="buku">
              <center><img src="gambar/<?php echo $buku1['gambar'] ?>" style="margin-top:20px;width:200px;height:190px;"></center>
              <h3 style="text-align:center; color:#007DBC; "><?php echo $buku1['judul'] ?></h3>
    ...
    <div class="row" style="background:#7e7c78;">
      <div class="col-md-4">
        <div style="margin:50px;height:120px;">
          <center>
            <ul>
              <li style="color:#f97b61">
                <h3><b>Tentang dodolBUKU</b></h3>
              </li>
            </ul>
          </center>
          <hr>
