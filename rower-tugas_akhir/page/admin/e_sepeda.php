...
mysqli_query($conn,"UPDATE sepeda set id_ketegori='$id_kategori', nama='$nama', gambar='$nama_file_baru',deskripsi='$deskripsi',harga='$harga', stok='$stok' where id_sepeda='$id_sepeda'");
...
if($_FILES['gambar']['name']){
	...
	if(!$_FILES['gambar']['error']){
		...
		if($valid_file == true)
		{
			...
			mysqli_query($conn,"UPDATE sepeda set nama='$nama',id_ketegori='$id_kategori',deskripsi='$deskripsi',harga='$harga', gambar='$nama_file_baru', stok='$stok' where id_sepeda='$id_sepeda'");
