...
include"../../koneksi_uzlah.php";
	...
	$harga = $_POST['harga'];
	$stok = $_POST['stok'];
	$qryid = mysqli_query($koneksi_uzlah,"SELECT * FROM kategori where kategori='$kat'");
...
if($_FILES['gambar']['name']){
	...
	if(!$_FILES['gambar']['error']){
		...
		if($valid_file == true)
		{
			...
			mysqli_query($koneksi_uzlah,"INSERT into sepeda set nama='$nama',id_ketegori='$id_kategori',deskripsi='$deskripsi',harga='$harga', gambar='$nama_file_baru', stok='$stok'");
