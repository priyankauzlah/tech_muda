...
<table class="table table-bordered">
		<th style=" background: #E6E6FA; "><center>Nama Sepeda</center></th>
	...
	<tr>
		<td><center><?php $data=mysqli_fetch_assoc(mysqli_query($conn,"SELECT * from sepeda where id_sepeda='$c[id_sepeda]'"));$nama=$data['judul']; echo $nama; ?></center></td>
