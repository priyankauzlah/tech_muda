	...
	<table class="table table-bordered" style="margin-top:20px;">
		...
		<?php while ($data = mysqli_fetch_assoc($qry_sepeda)) { ?>
			<tr>
				...
				<td><a href="index.php?page=editsepeda&id=<?php echo $data['id_sepeda']; ?>">
						<center>| <span class="glyphicon glyphicon-pencil"></span>
					</a> | | <a href="hapus_sepeda.php?id=<?php echo $data['id_sepeda']; ?>"><span class="glyphicon glyphicon-trash"></span> |</center></a></td>
			</tr>
		<?php } ?>
	</table>
</div>